...
def random_mini_batches(X, Y, mini_batch_size = 256, seed = 0):
    ...
    num_complete_minibatches = math.floor(m/mini_batch_size) # number of mini batchesof size mini_batch_size in your partitionning
...
def predict(X, y, parameters):
    ...
    file1=open("predictions_m4.txt","w")
    file2=open("truelabels_m4.txt","w")
...
def model(X, Y, layers_dims, learning_rate = 1e-7, mini_batch_size = 256, beta1 = 0.9, beta2 = 0.99, epsilon = 1e-8, num_epochs = 1700, print_cost =True):
